...
import com.example.management.domain.Users.Users;
import com.example.management.domain.UsersLicense;
import com.example.management.form.StationTimeForm;
import com.example.management.service.LoginUserDetails;
import com.example.management.service.ProjectService;
import com.example.management.service.SpecDetailService;
import com.example.management.service.UsersLicenseService;
...
public class SpecDetailController {
	@Autowired
	private UsersLicenseService usersLicenseService;
	@Autowired
...
//	@Autowired
//	private SpecDeleteController specDeleteController;
	
	@ModelAttribute
	public StationTimeForm setUpForm(){
		return new StationTimeForm();
	}
...
//			@ModelAttribute("staffId")String staffId,//追加
		...
		//いらないぽ
//		SpecEditForm form = new SpecEditForm();
//		form.setStaffId(searchStaffId);
//		
//		if(searchStaffId == null) {
//			form.setStaffId(loginUser.getUser().getStaffId());
//		}
//		
//		model.addAttribute("staffId",form.getStaffId());
//		findByStaffId(form, model);
		//ここまで
	...
	public String findByStaffId(String staffId,Model model){
		...
		//ログイン結合後まで保持
		Users user = new Users(staffId, "名前", "姓", "名", "姓(ﾌﾘｶﾞﾅ)", "名(ﾌﾘｶﾞﾅ)", 2, "boost2000");
	...
	private void sexList(Model model, Spec spec) {
		Map<Integer, String> sexMap = new LinkedHashMap<Integer, String>();

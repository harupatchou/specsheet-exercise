...
public class SkillPage {
	protected static final int COL_SIZE = 8;
	/** 氏名 */
	protected String name;
	/** 経験言語のリスト */
	protected ArrayList<String> languageNameList;
	/** 経験言語のリスト */
	protected ArrayList<Integer> monthOfLangList;
	/** 開発関連技術リスト */
	protected ArrayList<String> relatedTechList;
	/** OS経験リスト */
	protected ArrayList<String> osNameList;
	/** OS経験月数リスト */
	protected ArrayList<Integer> monthOfOsList;
	/** 経験工程リスト */
	protected ArrayList<String> processNameList;
	
	protected ArrayList<Boolean> expFlagList;
	/** スキル要約欄に記載する全ての要素 */
	protected ArrayList<String> allContents;
	
	protected ArrayList<Integer> maxSize;
//	
//	/**

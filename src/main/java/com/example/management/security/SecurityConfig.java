...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		http.authorizeRequests().antMatchers("/flowMenu","/spec/registIndex","/spec/regist","/spec/check",
				"/spec/edit","/detail/","/userRegist/","/userRegist/flowConfirm","/userRegist/create/",
				"/userEdit/","/userEdit/flowConfirm","/userEdit/update").hasAnyRole("USER","ADMIN") //ユーザー・管理者ともにアクセス可

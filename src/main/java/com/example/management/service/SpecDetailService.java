...
import com.example.management.domain.Division;
import com.example.management.domain.Spec;
import com.example.management.domain.User;
import com.example.management.form.StationTimeForm;
import com.example.management.repository.LanguageExpRepository;
...
public class SpecDetailService {
	...
	public SkillPage execute(User user) {
	...
	public Division allExpResult(String staffId) {
		Spec spec = specRepository.findByStaffId(staffId);

				...
				<p>性別：
		 		...
		 		<p>
					...
					<c:if test="${userData.staffIdFirst == 'NW'}">
		 			...
		 			<form:input path="staffIdSecond" value="${userData.staffIdSecond}" class="validate[required,custom[number],minNumberSize[3],maxNumberSize[3]]" size="4"/>-
		 			<form:input path="staffIdThird" value="${userData.staffIdThird}" class="validate[required,custom[number],minNumberSize[4],maxNumberSize[4]]" size="4"/>
		 		</p>
	 			<p>権限：
